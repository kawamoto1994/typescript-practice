const countButton = document.querySelector('[data-count]') as HTMLElement;
let countNum : number = 0;
const targetElement_250531_03 = document.querySelector('[data-test]') as HTMLElement;
const targetElement0 = document.querySelector('[data-test-0]') as HTMLElement;
